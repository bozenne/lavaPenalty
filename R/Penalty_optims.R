...
optim.proxGrad <- function(start, objective, gradient, hessian, control, ...){
    ...
    initL12 <- initialize.penaltyL12(penalty,
                                     name.x = name.coef,
                                     model.x = control.proxGrad$model.coef,
    ...
    resInit <- initializeOperator(lambda1 = initL12$lambda1, index.penalty1 = initL12$index.penalty1, index.model1 = initL12$index.model1,
                                  lambda2 = initL12$lambda2, index.penalty2 = initL12$index.penalty2, index.model2 = initL12$index.model2,
                                  lambdaG = initL12$lambdaG, index.penaltyG = initL12$index.penaltyG, index.modelG = initL12$index.modelG,
...
optim.EPSODE <- function(start, objective, gradient, hessian, control, ...){
    ...
    # {{{ update according to the coefficients present in start
    initL12 <- initialize.penaltyL12(penalty, name.x = name.coef, model.x = control$proxGrad$model.coef,  regularizationPath = TRUE)
